...
<div class="obsah_O_Nas">
    <div class="Karta_O_Nas">
        <img src="https://pickvisa.com/storage/public/articles/2e3bfb92a69446c286478c1dee9f2592.jpg"
             class="responsiveR" alt="obrazok111" height="200"
             width="500">
    ...
    <div class="Karta_O_Nas">
        <img src="https://sundsvallturism.com/wp-content/uploads/2020/03/Finding-the-Phuket-Area-of-Thailand-1000x500.jpg"
             alt="obrazok2" height="200" width="500">
    ...
    <div class="Karta_O_Nas">
        <img src="https://m.psecn.photoshelter.com/img-get/I0000.OuRtZJBwl8/s/1000/1000/kenya-amboseli-acacia-tree-sunrise.jpg"
             alt="obrazok3" height="200" width="500">
        <p>"But I must explain to you how all this mistaken idea of denouncing pleasure and praising pain was born
            and I will give you a complete account of the system, and expound the actual teachings of the great
            explorer of the truth, the master-builder of human happiness. No one rejects, dislikes, or avoids
            pleasure itself, because it is pleasure, but because those who do not know how to pursue pleasure
